...
if ( !isset($_SESSION['name']))
   ...
   $select_query = "SELECT  id,name,class,quantity,images FROM items WHERE category='Secondary' ";
         ...
         <?php
          ...
          <div class="caption">
              <h3><?php echo $row['name']; ?></h3>
                            ...
                            <a href="shop3.php?imd=<?php echo $pro_id;?>" name="add" value="add" class="btn btn-block btn-primary">Add to cart</a>
                                   <?php } ?>
          </div>
...
if(isset($_GET['imd']))
{
    ...
    echo "<script type='text/javascript'>window.open('shop3.php','_self')</script>";
                        exit();
}
                        ?>
